#!/bin/bash
# Hack ALL v1.7
# Coded by: *Namaku_Namamu* (Dilarang Berbuat KEJAM!!!)
# Github: https://github.com/NamakuNamamu7/NamakuNamamu
# 18 more tools HACK!!!
# Jangan digunakan untuk kekejaman!!!
...
printf "\e[1;77m  _   _    _             _  _  ______   _      _        _      \e[0m\n"
printf "\e[1;77m | | | |  | |           | || |(_____ \ | |    (_)      | |     \e[0m\n"
printf "\e[1;77m | |_| |   | | _    ____ | || | _____) )| | _   _   ___ | | _   \e[0m\n"
printf "\e[1;77m |  _  ||   | \  / _  )| || ||  ____/ | || \ | | /___)| || \  \e[0m\n"
